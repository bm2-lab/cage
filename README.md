...
Evaluation Model| Species | Cell Type | KO Efficiency Measurement | Data Type | Learning Model | Performance | Actual sgRNA Library Size | Accession 
  ---------|-----|-----|-------|---------|-------|------|-------|----
a375_1 | Homo sapiens | A375 | See [Doench et al.][1] | numerical | LASSO | r2=0.504 | 1248 | -     
 el4_1 | Mus musculus | EL4 | See [Doench et al.][1] | numerical | LASSO | r2=0.508 | 858 | -       
 mesc_1 | Mus musculus | mESC | OTF Ratio | numerical | LASSO | r2=0.72 | 99 | [ERP003292][2]       
 rn2c_1 | Mus musculus | RN2c | OTF Ratio | numerical | LASSO | r2=0.89| 26 | [SRP057117][3]        
 hela_1 | Homo sapiens | Hela | OTF Ratio | numerical | LASSO | r2=0.87| 68 | [SRP042061][4]        
 dr_1 | Danio rerio | *AB/Tu | OTF Ratio | numerical | LASSO | r2=0.91| 47 | [SRP052749][5]         
 hl60_nonribo | Homo sapiens | HL60 | See [Xu et al.][6] | categorical|Logistic | AUC=0.76 | 908 | -   
 hl60_ribo | Homo sapiens | HL60 | See [Xu et al.][6] | categorical| Logistic | AUC=0.79 | 373 | - 
 mesc_2 | Mus musculus | mESC | See [Xu et al.][6] | categorical | Logistic | AUC=0.81 | 1028 | - 
 hek293t_1 | Homo sapiens | HEK293T | See [Chari et al.][7] | categorical| Logistic | AUC=0.77 | 279 | - 
